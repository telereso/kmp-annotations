...
actual open class AnnotationsClientDatabaseDriverFactory(databaseName: String? = null) :
    ...
    actual override fun getAsyncSchema(): SqlSchema<QueryResult.AsyncValue<Unit>> = AnnotationsClientDatabase.Schema
    override fun getSchema(): SqlSchema<QueryResult.Value<Unit>>? = null
}